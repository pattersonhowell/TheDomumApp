...
public class Listing {
	...
	public void generateApplication(User user)  {	
		try {	
			...
			//File fileWrite  = new File("/DommumApp/TextFiles/Application"+user.getName());
			//File fileRead  = new File("C:/Users/Kevin Hagan/Desktop/DOMUM/DomumApp/TextFiles")
			File fileRead  = new File("C:/Users/Kevin Hagan/Desktop/DOMUM/DomumApp/TextFiles/Application.txt");
			File fileWrite  = new File("C:/Users/Kevin Hagan/Desktop/DOMUM/DomumApp/TextFiles/Application" +user.getName());	
